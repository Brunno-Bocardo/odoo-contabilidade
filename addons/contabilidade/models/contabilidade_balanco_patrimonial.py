...
class ContabilidadeBalancoPatrimonialWizard(models.TransientModel):
    ...
    data_base = fields.Date(string='Data-base', required=True, default=lambda self: fields.Date.context_today(self))
    ...
    def _compute_balanco(self):
        ...
        for wizard in self:
            ...
            if not wizard.data_base:
                ...
                wizard.total_passivo_patrimonio = 0.0
                continue
...
class ContabilidadeBalancoPatrimonialLine(models.TransientModel):
    ...
    conta_id = fields.Many2one('contabilidade.contas', string='Conta', required=True, index=True)
